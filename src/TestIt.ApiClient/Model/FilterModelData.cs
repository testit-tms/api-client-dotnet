...
namespace TestIT.ApiClient.Model
{
    ...
    /// FilterModelData
    /// </summary>
    [DataContract(Name = "FilterModel_data")]
    public partial class FilterModelData : IEquatable<FilterModelData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterModelData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FilterModelData);
        }

        /// <summary>
        /// Returns true if FilterModelData instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterModelData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterModelData input)
        {
            if (input == null)
            {
                return false;
