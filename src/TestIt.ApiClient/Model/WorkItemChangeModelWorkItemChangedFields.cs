...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkItemChangeModel_workItemChangedFields")]
    public partial class WorkItemChangeModelWorkItemChangedFields : IEquatable<WorkItemChangeModelWorkItemChangedFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemChangeModelWorkItemChangedFields" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkItemChangeModelWorkItemChangedFields() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemChangeModelWorkItemChangedFields" /> class.
        /// </summary>
        ...
        public WorkItemChangeModelWorkItemChangedFields(StringChangedFieldWithDiffsViewModel name = default(StringChangedFieldWithDiffsViewModel), WorkItemChangedFieldsViewModelIsDeleted isDeleted = default(WorkItemChangedFieldsViewModelIsDeleted), WorkItemChangedFieldsViewModelProjectId projectId = default(WorkItemChangedFieldsViewModelProjectId), WorkItemChangedFieldsViewModelIsDeleted isAutomated = default(WorkItemChangedFieldsViewModelIsDeleted), WorkItemChangedFieldsViewModelProjectId sectionId = default(WorkItemChangedFieldsViewModelProjectId), StringChangedFieldWithDiffsViewModel description = default(StringChangedFieldWithDiffsViewModel), WorkItemChangedFieldsViewModelState state = default(WorkItemChangedFieldsViewModelState), WorkItemChangedFieldsViewModelState priority = default(WorkItemChangedFieldsViewModelState), WorkItemChangedFieldsViewModelDuration duration = default(WorkItemChangedFieldsViewModelDuration), Dictionary<string, WorkItemChangedAttributeViewModel> attributes = default(Dictionary<string, WorkItemChangedAttributeViewModel>), WorkItemChangedFieldsViewModelSteps steps = default(WorkItemChangedFieldsViewModelSteps), WorkItemChangedFieldsViewModelSteps preconditionSteps = default(WorkItemChangedFieldsViewModelSteps), WorkItemChangedFieldsViewModelSteps postconditionSteps = default(WorkItemChangedFieldsViewModelSteps), WorkItemChangedFieldsViewModelAutoTests autoTests = default(WorkItemChangedFieldsViewModelAutoTests), WorkItemChangedFieldsViewModelAttachments attachments = default(WorkItemChangedFieldsViewModelAttachments), WorkItemChangedFieldsViewModelTags tags = default(WorkItemChangedFieldsViewModelTags), WorkItemChangedFieldsViewModelLinks links = default(WorkItemChangedFieldsViewModelLinks), WorkItemChangedFieldsViewModelGlobalId globalId = default(WorkItemChangedFieldsViewModelGlobalId), WorkItemChangedFieldsViewModelDuration versionNumber = default(WorkItemChangedFieldsViewModelDuration), WorkItemChangedFieldsViewModelState entityTypeName = default(WorkItemChangedFieldsViewModelState))
        {
            ...
            if (isDeleted == null)
            {
                throw new ArgumentNullException("isDeleted is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.IsDeleted = isDeleted;
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new ArgumentNullException("projectId is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.ProjectId = projectId;
            // to ensure "isAutomated" is required (not null)
            if (isAutomated == null)
            {
                throw new ArgumentNullException("isAutomated is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.IsAutomated = isAutomated;
            // to ensure "sectionId" is required (not null)
            if (sectionId == null)
            {
                throw new ArgumentNullException("sectionId is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.SectionId = sectionId;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.State = state;
            // to ensure "priority" is required (not null)
            if (priority == null)
            {
                throw new ArgumentNullException("priority is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Priority = priority;
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new ArgumentNullException("duration is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Duration = duration;
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Attributes = attributes;
            // to ensure "steps" is required (not null)
            if (steps == null)
            {
                throw new ArgumentNullException("steps is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Steps = steps;
            // to ensure "preconditionSteps" is required (not null)
            if (preconditionSteps == null)
            {
                throw new ArgumentNullException("preconditionSteps is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.PreconditionSteps = preconditionSteps;
            // to ensure "postconditionSteps" is required (not null)
            if (postconditionSteps == null)
            {
                throw new ArgumentNullException("postconditionSteps is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.PostconditionSteps = postconditionSteps;
            // to ensure "autoTests" is required (not null)
            if (autoTests == null)
            {
                throw new ArgumentNullException("autoTests is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.AutoTests = autoTests;
            // to ensure "attachments" is required (not null)
            if (attachments == null)
            {
                throw new ArgumentNullException("attachments is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Attachments = attachments;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Tags = tags;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.Links = links;
            // to ensure "globalId" is required (not null)
            if (globalId == null)
            {
                throw new ArgumentNullException("globalId is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.GlobalId = globalId;
            // to ensure "versionNumber" is required (not null)
            if (versionNumber == null)
            {
                throw new ArgumentNullException("versionNumber is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
            this.VersionNumber = versionNumber;
            // to ensure "entityTypeName" is required (not null)
            if (entityTypeName == null)
            {
                throw new ArgumentNullException("entityTypeName is a required property for WorkItemChangeModelWorkItemChangedFields and cannot be null");
            }
        ...
        {
            return this.Equals(input as WorkItemChangeModelWorkItemChangedFields);
        }

        /// <summary>
        /// Returns true if WorkItemChangeModelWorkItemChangedFields instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemChangeModelWorkItemChangedFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemChangeModelWorkItemChangedFields input)
        {
            if (input == null)
            {
                return false;
