...
namespace TestIT.ApiClient.Model
{
    ...
    /// CreateEmptyRequest
    /// </summary>
    [DataContract(Name = "CreateEmpty_request")]
    public partial class CreateEmptyRequest : IEquatable<CreateEmptyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmptyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEmptyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmptyRequest" /> class.
        /// </summary>
        ...
        public CreateEmptyRequest(Guid projectId = default(Guid), string name = default(string), string description = default(string), string launchSource = default(string), List<AssignAttachmentApiModel> attachments = default(List<AssignAttachmentApiModel>), List<CreateLinkApiModel> links = default(List<CreateLinkApiModel>))
        {
        ...
        {
            return this.Equals(input as CreateEmptyRequest);
        }

        /// <summary>
        /// Returns true if CreateEmptyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateEmptyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEmptyRequest input)
        {
            if (input == null)
            {
                return false;
