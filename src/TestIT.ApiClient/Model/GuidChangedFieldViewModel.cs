...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GuidChangedFieldViewModel")]
    public partial class GuidChangedFieldViewModel : IEquatable<GuidChangedFieldViewModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GuidChangedFieldViewModel);
        }

        /// <summary>
        /// Returns true if GuidChangedFieldViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of GuidChangedFieldViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuidChangedFieldViewModel input)
        {
            if (input == null)
            {
                return false;
