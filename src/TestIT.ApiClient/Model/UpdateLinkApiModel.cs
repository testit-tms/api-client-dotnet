...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class UpdateLinkApiModel : IEquatable<UpdateLinkApiModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateLinkApiModel);
        }

        /// <summary>
        /// Returns true if UpdateLinkApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateLinkApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateLinkApiModel input)
        {
            if (input == null)
            {
                return false;
