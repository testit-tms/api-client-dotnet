...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class GetExternalFormApiResultForm : IEquatable<GetExternalFormApiResultForm>, IValidatableObject
    {
        ...
        public GetExternalFormApiResultForm(List<ExternalFormFieldModel> fields = default(List<ExternalFormFieldModel>), Dictionary<string, List<ExternalFormAllowedValueModel>> possibleValues = default(Dictionary<string, List<ExternalFormAllowedValueModel>>), List<ExternalFormLinkModel> links = default(List<ExternalFormLinkModel>))
        {
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for GetExternalFormApiResultForm and cannot be null");
            }
            this.Links = links;
        }
