...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestPlanTestPointsGroupApiModel")]
    public partial class TestPlanTestPointsGroupApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPlanTestPointsGroupApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestPlanTestPointsGroupApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPlanTestPointsGroupApiModel" /> class.
        /// </summary>
        ...
        public TestPlanTestPointsGroupApiModel(string field = default(string), string displayField = default(string))
        {
            ...
            if (field == null)
            {
                throw new ArgumentNullException("field is a required property for TestPlanTestPointsGroupApiModel and cannot be null");
            }
            this.Field = field;
