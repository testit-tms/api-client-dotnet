...
namespace TestIT.ApiClient.Model
{
    ...
    /// StepResultApiModel
    /// </summary>
    [DataContract(Name = "StepResultApiModel")]
    public partial class StepResultApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepResultApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StepResultApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StepResultApiModel" /> class.
        /// </summary>
        ...
        public StepResultApiModel(Guid stepId = default(Guid), string outcome = default(string), Guid? sharedStepVersionId = default(Guid?), List<SharedStepResultApiModel> sharedStepResults = default(List<SharedStepResultApiModel>), StepCommentApiModel comment = default(StepCommentApiModel))
        {
            ...
            if (outcome == null)
            {
                throw new ArgumentNullException("outcome is a required property for StepResultApiModel and cannot be null");
            }
        ...
        public List<SharedStepResultApiModel> SharedStepResults { get; set; }

        /// <summary>
        /// Gets or Sets Comment
        /// </summary>
        [DataMember(Name = "comment", EmitDefaultValue = true)]
        public StepCommentApiModel Comment { get; set; }
