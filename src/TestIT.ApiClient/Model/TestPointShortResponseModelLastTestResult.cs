...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestPointShortResponseModel_lastTestResult")]
    public partial class TestPointShortResponseModelLastTestResult : IEquatable<TestPointShortResponseModelLastTestResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPointShortResponseModelLastTestResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestPointShortResponseModelLastTestResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPointShortResponseModelLastTestResult" /> class.
        /// </summary>
        ...
        public TestPointShortResponseModelLastTestResult(Guid id = default(Guid), Guid testRunId = default(Guid), Guid? autoTestId = default(Guid?), string comment = default(string), List<LinkModel> links = default(List<LinkModel>), Guid workItemVersionId = default(Guid), List<AttachmentModel> attachments = default(List<AttachmentModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestPointShortResponseModelLastTestResult {\n");
        ...
        {
            return this.Equals(input as TestPointShortResponseModelLastTestResult);
        }

        /// <summary>
        /// Returns true if TestPointShortResponseModelLastTestResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPointShortResponseModelLastTestResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPointShortResponseModelLastTestResult input)
        {
            if (input == null)
            {
                return false;
