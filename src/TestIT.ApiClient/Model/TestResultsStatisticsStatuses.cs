...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsStatuses")]
    public partial class TestResultsStatisticsStatuses : IEquatable<TestResultsStatisticsStatuses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsStatuses" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestResultsStatisticsStatuses() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsStatuses" /> class.
        /// </summary>
        ...
        public TestResultsStatisticsStatuses(int inProgress = default(int), int passed = default(int), int failed = default(int), int skipped = default(int), int blocked = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestResultsStatisticsStatuses {\n");
        ...
        {
            return this.Equals(input as TestResultsStatisticsStatuses);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsStatuses instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsStatuses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsStatuses input)
        {
            if (input == null)
            {
                return false;
