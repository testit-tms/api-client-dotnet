...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_webhooks_search_post_request")]
    public partial class ApiV2WebhooksSearchPostRequest : IEquatable<ApiV2WebhooksSearchPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2WebhooksSearchPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2WebhooksSearchPostRequest(string name = default(string), List<WebHookEventTypeModel> eventTypes = default(List<WebHookEventTypeModel>), List<RequestTypeModel> methods = default(List<RequestTypeModel>), List<Guid> projectIds = default(List<Guid>), bool? isEnabled = default(bool?))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2WebhooksSearchPostRequest {\n");
        ...
        {
            return this.Equals(input as ApiV2WebhooksSearchPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2WebhooksSearchPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2WebhooksSearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2WebhooksSearchPostRequest input)
        {
            if (input == null)
            {
                return false;
