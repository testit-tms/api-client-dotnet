...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class WebhooksFilterRequest : IValidatableObject
    {
        ...
        public WebhooksFilterRequest(string name = default(string), List<WebHookEventTypeRequest> eventTypes = default(List<WebHookEventTypeRequest>), List<RequestTypeRequest> methods = default(List<RequestTypeRequest>), List<Guid> projectIds = default(List<Guid>))
        {
            this.Name = name;
