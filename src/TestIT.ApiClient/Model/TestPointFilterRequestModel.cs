...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPointFilterRequestModel : IEquatable<TestPointFilterRequestModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TestPointFilterRequestModel);
        }

        /// <summary>
        /// Returns true if TestPointFilterRequestModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPointFilterRequestModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPointFilterRequestModel input)
        {
            if (input == null)
            {
                return false;
