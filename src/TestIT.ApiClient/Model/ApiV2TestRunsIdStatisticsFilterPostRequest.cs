...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_testRuns__id__statistics_filter_post_request")]
    public partial class ApiV2TestRunsIdStatisticsFilterPostRequest : IEquatable<ApiV2TestRunsIdStatisticsFilterPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2TestRunsIdStatisticsFilterPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2TestRunsIdStatisticsFilterPostRequest(List<Guid> configurationIds = default(List<Guid>), List<TestResultOutcome> outcomes = default(List<TestResultOutcome>), List<string> statusCodes = default(List<string>), List<FailureCategoryModel> failureCategories = default(List<FailureCategoryModel>), string _namespace = default(string), string className = default(string))
        {
        ...
        {
            return this.Equals(input as ApiV2TestRunsIdStatisticsFilterPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2TestRunsIdStatisticsFilterPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2TestRunsIdStatisticsFilterPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2TestRunsIdStatisticsFilterPostRequest input)
        {
            if (input == null)
            {
                return false;
