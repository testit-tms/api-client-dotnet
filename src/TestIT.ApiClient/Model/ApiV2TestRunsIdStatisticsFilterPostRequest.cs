...
namespace TestIt.ApiClient.Model
{
    ...
    public partial class ApiV2TestRunsIdStatisticsFilterPostRequest : IEquatable<ApiV2TestRunsIdStatisticsFilterPostRequest>, IValidatableObject
    {
        ...
        public ApiV2TestRunsIdStatisticsFilterPostRequest(List<Guid> configurationIds = default(List<Guid>), List<TestResultOutcome> outcomes = default(List<TestResultOutcome>), List<FailureCategoryModel> failureCategories = default(List<FailureCategoryModel>), string _namespace = default(string), string className = default(string))
        {
