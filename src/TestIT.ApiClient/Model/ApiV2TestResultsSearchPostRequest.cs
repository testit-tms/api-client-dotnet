...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_testResults_search_post_request")]
    public partial class ApiV2TestResultsSearchPostRequest : IEquatable<ApiV2TestResultsSearchPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2TestResultsSearchPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2TestResultsSearchPostRequest(List<Guid> testRunIds = default(List<Guid>), List<Guid> configurationIds = default(List<Guid>), List<TestResultOutcome> outcomes = default(List<TestResultOutcome>), List<FailureCategoryModel> failureCategories = default(List<FailureCategoryModel>), string _namespace = default(string), string className = default(string))
        {
        ...
        {
            return this.Equals(input as ApiV2TestResultsSearchPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2TestResultsSearchPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2TestResultsSearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2TestResultsSearchPostRequest input)
        {
            if (input == null)
            {
                return false;
