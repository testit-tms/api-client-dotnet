...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class GlobalCustomAttributePostModel : IValidatableObject
    {
        ...
        public GlobalCustomAttributePostModel(string name = default, bool? isEnabled = default, bool? isRequired = default, List<CustomAttributeOptionPostModel> options = default, CustomAttributeTypesEnum type = default)
        {
