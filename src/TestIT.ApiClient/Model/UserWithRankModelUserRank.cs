...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserWithRankModel_userRank")]
    public partial class UserWithRankModelUserRank : IEquatable<UserWithRankModelUserRank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserWithRankModelUserRank" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserWithRankModelUserRank() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserWithRankModelUserRank" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UserWithRankModelUserRank);
        }

        /// <summary>
        /// Returns true if UserWithRankModelUserRank instances are equal
        /// </summary>
        /// <param name="input">Instance of UserWithRankModelUserRank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserWithRankModelUserRank input)
        {
            if (input == null)
            {
                return false;
