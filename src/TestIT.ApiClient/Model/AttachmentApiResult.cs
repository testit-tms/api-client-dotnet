...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class AttachmentApiResult : IEquatable<AttachmentApiResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AttachmentApiResult);
        }

        /// <summary>
        /// Returns true if AttachmentApiResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentApiResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentApiResult input)
        {
            if (input == null)
            {
                return false;
