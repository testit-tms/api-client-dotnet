...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhooksUpdateRequest_filter")]
    public partial class WebhooksUpdateRequestFilter : IEquatable<WebhooksUpdateRequestFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksUpdateRequestFilter" /> class.
        /// </summary>
        ...
        public WebhooksUpdateRequestFilter(string name = default(string), List<WebHookEventTypeRequest> eventTypes = default(List<WebHookEventTypeRequest>), List<RequestTypeRequest> methods = default(List<RequestTypeRequest>), List<Guid> projectIds = default(List<Guid>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as WebhooksUpdateRequestFilter);
        }

        /// <summary>
        /// Returns true if WebhooksUpdateRequestFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhooksUpdateRequestFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhooksUpdateRequestFilter input)
        {
            if (input == null)
            {
                return false;
