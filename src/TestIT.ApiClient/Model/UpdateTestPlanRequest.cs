...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateTestPlan_request")]
    public partial class UpdateTestPlanRequest : IEquatable<UpdateTestPlanRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTestPlanRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateTestPlanRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTestPlanRequest" /> class.
        /// </summary>
        ...
        public UpdateTestPlanRequest(Guid id = default(Guid), Guid? lockedById = default(Guid?), List<TagShortModel> tags = default(List<TagShortModel>), string name = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string description = default(string), string build = default(string), Guid projectId = default(Guid), string productName = default(string), bool? hasAutomaticDurationTimer = default(bool?), Dictionary<string, Object> attributes = default(Dictionary<string, Object>))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateTestPlanRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateTestPlanRequest);
        }

        /// <summary>
        /// Returns true if UpdateTestPlanRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTestPlanRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTestPlanRequest input)
        {
            if (input == null)
            {
                return false;
