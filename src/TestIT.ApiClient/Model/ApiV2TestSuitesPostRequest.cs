...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_testSuites_post_request")]
    public partial class ApiV2TestSuitesPostRequest : IEquatable<ApiV2TestSuitesPostRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2TestSuitesPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV2TestSuitesPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2TestSuitesPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2TestSuitesPostRequest(Guid? parentId = default(Guid?), Guid testPlanId = default(Guid), string name = default(string), TestSuiteType? type = default(TestSuiteType?), bool? saveStructure = default(bool?), bool? autoRefresh = default(bool?))
        {
            this.TestPlanId = testPlanId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ApiV2TestSuitesPostRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as ApiV2TestSuitesPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2TestSuitesPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2TestSuitesPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2TestSuitesPostRequest input)
        {
            if (input == null)
            {
                return false;
