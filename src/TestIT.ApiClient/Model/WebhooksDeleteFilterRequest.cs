...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class WebhooksDeleteFilterRequest : IEquatable<WebhooksDeleteFilterRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WebhooksDeleteFilterRequest);
        }

        /// <summary>
        /// Returns true if WebhooksDeleteFilterRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhooksDeleteFilterRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhooksDeleteFilterRequest input)
        {
            if (input == null)
            {
                return false;
