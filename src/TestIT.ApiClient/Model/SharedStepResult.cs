...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class SharedStepResult : IEquatable<SharedStepResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SharedStepResult);
        }

        /// <summary>
        /// Returns true if SharedStepResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedStepResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedStepResult input)
        {
            if (input == null)
            {
                return false;
