...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class UpdateSectionRequest : IEquatable<UpdateSectionRequest>, IValidatableObject
    {
        ...
        public UpdateSectionRequest(Guid id = default(Guid), string name = default(string), Guid projectId = default(Guid), Guid? parentId = default(Guid?), List<StepPutModel> preconditionSteps = default(List<StepPutModel>), List<StepPutModel> postconditionSteps = default(List<StepPutModel>), List<AttachmentPutModel> attachments = default(List<AttachmentPutModel>))
        {
            this.Id = id;
            ...
            if (attachments == null)
            {
                throw new ArgumentNullException("attachments is a required property for UpdateSectionRequest and cannot be null");
            }
