...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class ExternalFormCreateModel : IEquatable<ExternalFormCreateModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ExternalFormCreateModel);
        }

        /// <summary>
        /// Returns true if ExternalFormCreateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalFormCreateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalFormCreateModel input)
        {
            if (input == null)
            {
                return false;
