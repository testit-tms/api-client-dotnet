...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class BooleanChangedFieldViewModel : IEquatable<BooleanChangedFieldViewModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BooleanChangedFieldViewModel);
        }

        /// <summary>
        /// Returns true if BooleanChangedFieldViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of BooleanChangedFieldViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BooleanChangedFieldViewModel input)
        {
            if (input == null)
            {
                return false;
