...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPointShortResponseModel : IValidatableObject
    {
        ...
        public TestPointShortResponseModel(Guid id = default, DateTime createdDate = default, Guid createdById = default, DateTime? modifiedDate = default, Guid? modifiedById = default, Guid? testerId = default, Dictionary<string, string> parameters = default, Dictionary<string, Object> attributes = default, List<string> tags = default, List<string> links = default, Guid testSuiteId = default, string testSuiteName = default, Guid workItemId = default, long workItemGlobalId = default, Guid workItemVersionId = default, int workItemVersionNumber = default, long? workItemMedianDuration = default, TestPointStatus status = default, TestStatusApiResult statusModel = default, WorkItemPriorityModel priority = default, WorkItemSourceTypeModel sourceType = default, bool isAutomated = default, string name = default, Guid configurationId = default, int duration = default, Guid sectionId = default, string sectionName = default, Guid projectId = default, LastTestResultModel lastTestResult = default, Guid iterationId = default, WorkItemState workItemState = default, Guid workItemCreatedById = default, DateTime workItemCreatedDate = default, Guid? workItemModifiedById = default, DateTime? workItemModifiedDate = default)
        {
            this.Id = id;
