...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class Attachment : IValidatableObject
    {
        ...
        public Attachment(Guid id = default(Guid), string fileId = default(string), string type = default(string), float size = default(float), DateTime createdDate = default(DateTime), DateTime? modifiedDate = default(DateTime?), Guid createdById = default(Guid), Guid? modifiedById = default(Guid?), string name = default(string))
        {
            this.Id = id;
            // to ensure "fileId" is required (not null)
            if (fileId == null)
            {
                throw new ArgumentNullException("fileId is a required property for Attachment and cannot be null");
            }
            this.FileId = fileId;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Attachment and cannot be null");
            }
            this.Type = type;
            this.Size = size;
