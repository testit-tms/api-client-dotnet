...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateTestPlanApiModel")]
    public partial class UpdateTestPlanApiModel : IEquatable<UpdateTestPlanApiModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTestPlanApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateTestPlanApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTestPlanApiModel" /> class.
        /// </summary>
        ...
        public UpdateTestPlanApiModel(Guid id = default(Guid), Guid? lockedById = default(Guid?), string name = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string description = default(string), string build = default(string), Guid projectId = default(Guid), string productName = default(string), bool? hasAutomaticDurationTimer = default(bool?), Dictionary<string, Object> attributes = default(Dictionary<string, Object>), List<TagApiModel> tags = default(List<TagApiModel>))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateTestPlanApiModel and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateTestPlanApiModel);
        }

        /// <summary>
        /// Returns true if UpdateTestPlanApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTestPlanApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTestPlanApiModel input)
        {
            if (input == null)
            {
                return false;
