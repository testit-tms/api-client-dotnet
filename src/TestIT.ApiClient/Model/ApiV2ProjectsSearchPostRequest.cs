...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_projects_search_post_request")]
    public partial class ApiV2ProjectsSearchPostRequest : IEquatable<ApiV2ProjectsSearchPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ProjectsSearchPostRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2ProjectsSearchPostRequest {\n");
        ...
        {
            return this.Equals(input as ApiV2ProjectsSearchPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2ProjectsSearchPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2ProjectsSearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2ProjectsSearchPostRequest input)
        {
            if (input == null)
            {
                return false;
