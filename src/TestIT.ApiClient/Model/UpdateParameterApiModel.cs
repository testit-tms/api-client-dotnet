...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateParameterApiModel")]
    public partial class UpdateParameterApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateParameterApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateParameterApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateParameterApiModel" /> class.
        /// </summary>
        ...
        public UpdateParameterApiModel(Guid id = default(Guid), string name = default(string), string value = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateParameterApiModel and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>ID&#39;s of the parameter</value>
