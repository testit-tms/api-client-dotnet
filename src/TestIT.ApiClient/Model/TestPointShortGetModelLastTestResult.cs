...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestPointShortGetModel_lastTestResult")]
    public partial class TestPointShortGetModelLastTestResult : IEquatable<TestPointShortGetModelLastTestResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPointShortGetModelLastTestResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestPointShortGetModelLastTestResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPointShortGetModelLastTestResult" /> class.
        /// </summary>
        ...
        public TestPointShortGetModelLastTestResult(Guid id = default(Guid), Guid testRunId = default(Guid), Guid? autoTestId = default(Guid?), string comment = default(string), List<LinkModel> links = default(List<LinkModel>), Guid workItemVersionId = default(Guid), List<AttachmentModel> attachments = default(List<AttachmentModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestPointShortGetModelLastTestResult {\n");
        ...
        {
            return this.Equals(input as TestPointShortGetModelLastTestResult);
        }

        /// <summary>
        /// Returns true if TestPointShortGetModelLastTestResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPointShortGetModelLastTestResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPointShortGetModelLastTestResult input)
        {
            if (input == null)
            {
                return false;
