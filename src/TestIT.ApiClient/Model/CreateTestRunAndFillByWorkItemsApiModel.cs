...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class CreateTestRunAndFillByWorkItemsApiModel : IEquatable<CreateTestRunAndFillByWorkItemsApiModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateTestRunAndFillByWorkItemsApiModel);
        }

        /// <summary>
        /// Returns true if CreateTestRunAndFillByWorkItemsApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTestRunAndFillByWorkItemsApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTestRunAndFillByWorkItemsApiModel input)
        {
            if (input == null)
            {
                return false;
