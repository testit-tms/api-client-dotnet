...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsResponse_statuses")]
    public partial class TestResultsStatisticsResponseStatuses : IEquatable<TestResultsStatisticsResponseStatuses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsResponseStatuses" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestResultsStatisticsResponseStatuses() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsResponseStatuses" /> class.
        /// </summary>
        ...
        public TestResultsStatisticsResponseStatuses(int inProgress = default(int), int passed = default(int), int failed = default(int), int skipped = default(int), int blocked = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestResultsStatisticsResponseStatuses {\n");
        ...
        {
            return this.Equals(input as TestResultsStatisticsResponseStatuses);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsResponseStatuses instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsResponseStatuses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsResponseStatuses input)
        {
            if (input == null)
            {
                return false;
