...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsGetModel_statuses")]
    public partial class TestResultsStatisticsGetModelStatuses : IEquatable<TestResultsStatisticsGetModelStatuses>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TestResultsStatisticsGetModelStatuses);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsGetModelStatuses instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsGetModelStatuses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsGetModelStatuses input)
        {
            if (input == null)
            {
                return false;
