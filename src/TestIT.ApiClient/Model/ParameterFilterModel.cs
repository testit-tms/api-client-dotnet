...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class ParameterFilterModel : IEquatable<ParameterFilterModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ParameterFilterModel);
        }

        /// <summary>
        /// Returns true if ParameterFilterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ParameterFilterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParameterFilterModel input)
        {
            if (input == null)
            {
                return false;
