...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultLinkApiResult : IValidatableObject
    {
        ...
        public TestResultLinkApiResult(Guid? id = default, string title = default, string url = default, string description = default, LinkType? type = default, bool hasInfo = default)
        {
        ...
        /// </summary>
        /// <value>Link name. Backward compatibility.</value>
