...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class SectionPutModel : IEquatable<SectionPutModel>, IValidatableObject
    {
        ...
        public SectionPutModel(Guid id = default(Guid), string name = default(string), Guid projectId = default(Guid), Guid? parentId = default(Guid?), List<StepPutModel> preconditionSteps = default(List<StepPutModel>), List<StepPutModel> postconditionSteps = default(List<StepPutModel>))
        {
            this.Id = id;
