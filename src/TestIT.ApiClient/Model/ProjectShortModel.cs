...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class ProjectShortModel : IEquatable<ProjectShortModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProjectShortModel);
        }

        /// <summary>
        /// Returns true if ProjectShortModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectShortModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectShortModel input)
        {
            if (input == null)
            {
                return false;
