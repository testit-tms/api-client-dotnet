...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestStatusApiResult : IEquatable<TestStatusApiResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TestStatusApiResult);
        }

        /// <summary>
        /// Returns true if TestStatusApiResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TestStatusApiResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestStatusApiResult input)
        {
            if (input == null)
            {
                return false;
