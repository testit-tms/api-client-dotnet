...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class WebHookModel : IValidatableObject
    {
        ...
        public WebHookModel(string name = default, WebHookEventTypeModel eventType = default, string description = default, string url = default, RequestTypeModel requestType = default, bool shouldSendBody = default, Dictionary<string, string> headers = default, Dictionary<string, string> queryParameters = default, bool isEnabled = default, bool shouldSendCustomBody = default, string customBody = default, string customBodyMediaType = default, bool shouldReplaceParameters = default, bool shouldEscapeParameters = default, DateTime createdDate = default, Guid createdById = default, DateTime? modifiedDate = default, Guid? modifiedById = default, Guid projectId = default, Guid id = default, bool isDeleted = default)
        {
