...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPointWithLastResultResponseModel : IEquatable<TestPointWithLastResultResponseModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TestPointWithLastResultResponseModel);
        }

        /// <summary>
        /// Returns true if TestPointWithLastResultResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPointWithLastResultResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPointWithLastResultResponseModel input)
        {
            if (input == null)
            {
                return false;
