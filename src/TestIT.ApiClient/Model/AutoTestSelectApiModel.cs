...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AutoTestSelectApiModel")]
    public partial class AutoTestSelectApiModel : IEquatable<AutoTestSelectApiModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTestSelectApiModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AutoTestSelectApiModel);
        }

        /// <summary>
        /// Returns true if AutoTestSelectApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AutoTestSelectApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutoTestSelectApiModel input)
        {
            if (input == null)
            {
                return false;
