...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsApiResult_failureCategories")]
    public partial class TestResultsStatisticsApiResultFailureCategories : IEquatable<TestResultsStatisticsApiResultFailureCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsApiResultFailureCategories" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestResultsStatisticsApiResultFailureCategories() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsApiResultFailureCategories" /> class.
        /// </summary>
        ...
        public TestResultsStatisticsApiResultFailureCategories(int infrastructureDefect = default(int), int productDefect = default(int), int testDefect = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestResultsStatisticsApiResultFailureCategories {\n");
        ...
        {
            return this.Equals(input as TestResultsStatisticsApiResultFailureCategories);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsApiResultFailureCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsApiResultFailureCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsApiResultFailureCategories input)
        {
            if (input == null)
            {
                return false;
