...
namespace TestIt.ApiClient.Model
{
    ...
    public partial class ConfigurationFilterModel : IEquatable<ConfigurationFilterModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ConfigurationFilterModel);
        }

        /// <summary>
        /// Returns true if ConfigurationFilterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationFilterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationFilterModel input)
        {
            if (input == null)
            {
                return false;
