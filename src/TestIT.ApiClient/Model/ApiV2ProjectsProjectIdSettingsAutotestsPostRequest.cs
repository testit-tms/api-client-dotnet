...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_projects__projectId__settings_autotests_post_request")]
    public partial class ApiV2ProjectsProjectIdSettingsAutotestsPostRequest : IEquatable<ApiV2ProjectsProjectIdSettingsAutotestsPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ProjectsProjectIdSettingsAutotestsPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV2ProjectsProjectIdSettingsAutotestsPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ProjectsProjectIdSettingsAutotestsPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2ProjectsProjectIdSettingsAutotestsPostRequest(bool isFlakyAuto = false, int flakyStabilityPercentage = 100, int flakyTestRunCount = 100, bool rerunEnabled = default(bool), int rerunAttemptsCount = default(int))
        {
        ...
        {
            return this.Equals(input as ApiV2ProjectsProjectIdSettingsAutotestsPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2ProjectsProjectIdSettingsAutotestsPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2ProjectsProjectIdSettingsAutotestsPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2ProjectsProjectIdSettingsAutotestsPostRequest input)
        {
            if (input == null)
            {
                return false;
