...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPointPutModelStatusModel : IEquatable<TestPointPutModelStatusModel>, IValidatableObject
    {
        ...
        protected TestPointPutModelStatusModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPointPutModelStatusModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TestPointPutModelStatusModel);
        }

        /// <summary>
        /// Returns true if TestPointPutModelStatusModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPointPutModelStatusModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPointPutModelStatusModel input)
        {
            if (input == null)
            {
                return false;
