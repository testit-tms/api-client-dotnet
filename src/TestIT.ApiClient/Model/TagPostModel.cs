...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TagPostModel : IEquatable<TagPostModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TagPostModel);
        }

        /// <summary>
        /// Returns true if TagPostModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TagPostModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagPostModel input)
        {
            if (input == null)
            {
                return false;
