...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AutoTestShortApiResult")]
    public partial class AutoTestShortApiResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTestShortApiResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutoTestShortApiResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoTestShortApiResult" /> class.
        /// </summary>
        ...
        public AutoTestShortApiResult(Guid id = default(Guid), Guid projectId = default(Guid), string name = default(string), string externalId = default(string), long globalId = default(long))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AutoTestShortApiResult and cannot be null");
            }
            this.Name = name;
            // to ensure "externalId" is required (not null)
            if (externalId == null)
            {
                throw new ArgumentNullException("externalId is a required property for AutoTestShortApiResult and cannot be null");
            }
