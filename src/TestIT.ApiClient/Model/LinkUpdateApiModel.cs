...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class LinkUpdateApiModel : IValidatableObject
    {
        ...
        public LinkUpdateApiModel(Guid? id = default, string title = default, string url = default, string description = default, LinkType? type = default, bool hasInfo = default)
        {
