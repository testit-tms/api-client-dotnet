...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExportProjectJson_request")]
    public partial class ExportProjectJsonRequest : IEquatable<ExportProjectJsonRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportProjectJsonRequest" /> class.
        /// </summary>
        ...
        public ExportProjectJsonRequest(List<Guid> sectionIds = default(List<Guid>), List<Guid> workItemIds = default(List<Guid>))
        {
        ...
        {
            return this.Equals(input as ExportProjectJsonRequest);
        }

        /// <summary>
        /// Returns true if ExportProjectJsonRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportProjectJsonRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportProjectJsonRequest input)
        {
            if (input == null)
            {
                return false;
