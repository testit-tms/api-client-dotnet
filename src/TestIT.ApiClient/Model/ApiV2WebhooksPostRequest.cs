...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_webhooks_post_request")]
    public partial class ApiV2WebhooksPostRequest : IEquatable<ApiV2WebhooksPostRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2WebhooksPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV2WebhooksPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2WebhooksPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2WebhooksPostRequest(Guid projectId = default(Guid), WebHookEventTypeModel eventType = default(WebHookEventTypeModel), string description = default(string), string url = default(string), RequestTypeModel requestType = default(RequestTypeModel), bool shouldSendBody = default(bool), Dictionary<string, string> headers = default(Dictionary<string, string>), Dictionary<string, string> queryParameters = default(Dictionary<string, string>), bool isEnabled = default(bool), bool shouldSendCustomBody = default(bool), string customBody = default(string), bool shouldReplaceParameters = default(bool), bool shouldEscapeParameters = default(bool), string name = default(string))
        {
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for ApiV2WebhooksPostRequest and cannot be null");
            }
            this.Url = url;
            ...
            if (headers == null)
            {
                throw new ArgumentNullException("headers is a required property for ApiV2WebhooksPostRequest and cannot be null");
            }
            this.Headers = headers;
            // to ensure "queryParameters" is required (not null)
            if (queryParameters == null)
            {
                throw new ArgumentNullException("queryParameters is a required property for ApiV2WebhooksPostRequest and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ApiV2WebhooksPostRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as ApiV2WebhooksPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2WebhooksPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2WebhooksPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2WebhooksPostRequest input)
        {
            if (input == null)
            {
                return false;
