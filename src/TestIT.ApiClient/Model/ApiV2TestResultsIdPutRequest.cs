...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_testResults__id__put_request")]
    public partial class ApiV2TestResultsIdPutRequest : IEquatable<ApiV2TestResultsIdPutRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2TestResultsIdPutRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApiV2TestResultsIdPutRequest);
        }

        /// <summary>
        /// Returns true if ApiV2TestResultsIdPutRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2TestResultsIdPutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2TestResultsIdPutRequest input)
        {
            if (input == null)
            {
                return false;
