...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPlanWithTestSuiteTreeModel : IEquatable<TestPlanWithTestSuiteTreeModel>, IValidatableObject
    {
        ...
        public TestPlanWithTestSuiteTreeModel(List<TestSuiteWithChildrenModel> testSuites = default(List<TestSuiteWithChildrenModel>), TestPlanStatusModel status = default(TestPlanStatusModel), DateTime? startedOn = default(DateTime?), DateTime? completedOn = default(DateTime?), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), Guid createdById = default(Guid), Guid? modifiedById = default(Guid?), long globalId = default(long), bool isDeleted = default(bool), DateTime? lockedDate = default(DateTime?), Guid id = default(Guid), Guid? lockedById = default(Guid?), List<TagPostModel> tags = default(List<TagPostModel>), string name = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string description = default(string), string build = default(string), Guid projectId = default(Guid), string productName = default(string), bool? hasAutomaticDurationTimer = default(bool?), Dictionary<string, Object> attributes = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as TestPlanWithTestSuiteTreeModel);
        }

        /// <summary>
        /// Returns true if TestPlanWithTestSuiteTreeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPlanWithTestSuiteTreeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPlanWithTestSuiteTreeModel input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.TestSuites == input.TestSuites ||
                    this.TestSuites != null &&
                    input.TestSuites != null &&
                    this.TestSuites.SequenceEqual(input.TestSuites)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TestSuites.GetHashCode();
                }
