...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class AutoTestProjectSettingsGetModel : IEquatable<AutoTestProjectSettingsGetModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AutoTestProjectSettingsGetModel);
        }

        /// <summary>
        /// Returns true if AutoTestProjectSettingsGetModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AutoTestProjectSettingsGetModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutoTestProjectSettingsGetModel input)
        {
            if (input == null)
            {
                return false;
