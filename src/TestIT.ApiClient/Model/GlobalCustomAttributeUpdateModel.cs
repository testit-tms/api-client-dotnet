...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class GlobalCustomAttributeUpdateModel : IValidatableObject
    {
        ...
        public GlobalCustomAttributeUpdateModel(string name = default, List<CustomAttributeOptionModel> options = default, bool? isEnabled = default, bool? isRequired = default)
        {
