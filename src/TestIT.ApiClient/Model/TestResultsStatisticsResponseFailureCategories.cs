...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsResponse_failureCategories")]
    public partial class TestResultsStatisticsResponseFailureCategories : IEquatable<TestResultsStatisticsResponseFailureCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsResponseFailureCategories" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestResultsStatisticsResponseFailureCategories() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsResponseFailureCategories" /> class.
        /// </summary>
        ...
        public TestResultsStatisticsResponseFailureCategories(int infrastructureDefect = default(int), int productDefect = default(int), int testDefect = default(int))
        {
        ...
        {
            return this.Equals(input as TestResultsStatisticsResponseFailureCategories);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsResponseFailureCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsResponseFailureCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsResponseFailureCategories input)
        {
            if (input == null)
            {
                return false;
