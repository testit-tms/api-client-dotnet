...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectDetailedFailureCategoryApiResult")]
    public partial class ProjectDetailedFailureCategoryApiResult : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDetailedFailureCategoryApiResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectDetailedFailureCategoryApiResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDetailedFailureCategoryApiResult" /> class.
        /// </summary>
        ...
        public ProjectDetailedFailureCategoryApiResult(Guid id = default(Guid), string name = default(string), bool isDeleted = default(bool), FailureCategory failureCategory = default(FailureCategory), DateTime createdDate = default(DateTime), Guid createdById = default(Guid), DateTime? modifiedDate = default(DateTime?), Guid? modifiedById = default(Guid?), List<FailureClassRegexApiResult> failureClassRegexes = default(List<FailureClassRegexApiResult>), int projectsCount = default(int))
        {
            this.Id = id;
            ...
            {
                throw new ArgumentNullException("failureClassRegexes is a required property for ProjectDetailedFailureCategoryApiResult and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Projects relations count</value>
        [DataMember(Name = "projectsCount", IsRequired = true, EmitDefaultValue = true)]
