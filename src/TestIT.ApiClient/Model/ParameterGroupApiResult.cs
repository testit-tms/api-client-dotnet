...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParameterGroupApiResult")]
    public partial class ParameterGroupApiResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParameterGroupApiResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParameterGroupApiResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParameterGroupApiResult" /> class.
        /// </summary>
        ...
        public ParameterGroupApiResult(Guid parameterKeyId = default, string name = default, Dictionary<string, string> values = default, List<Guid> projectIds = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ParameterGroupApiResult and cannot be null");
            }
            this.Name = name;
