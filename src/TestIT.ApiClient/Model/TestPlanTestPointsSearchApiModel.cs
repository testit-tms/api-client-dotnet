...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestPlanTestPointsSearchApiModel")]
    public partial class TestPlanTestPointsSearchApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPlanTestPointsSearchApiModel" /> class.
        /// </summary>
        ...
        public TestPlanTestPointsSearchApiModel(List<Guid> testSuiteIds = default, List<long> workItemGlobalIds = default, Int64RangeSelectorModel workItemMedianDuration = default, List<TestPointStatus> statuses = default, List<string> statusCodes = default, List<WorkItemPriorityModel> priorities = default, bool? isAutomated = default, string name = default, List<Guid> configurationIds = default, List<Guid?> testerIds = default, Int64RangeSelectorModel duration = default, List<Guid> sectionIds = default, DateTimeRangeSelectorModel createdDate = default, List<Guid> createdByIds = default, DateTimeRangeSelectorModel modifiedDate = default, List<Guid> modifiedByIds = default, List<string> tags = default, List<string> excludeTags = default, Dictionary<string, List<string>> attributes = default, DateTimeRangeSelectorModel workItemCreatedDate = default, List<Guid> workItemCreatedByIds = default, DateTimeRangeSelectorModel workItemModifiedDate = default, List<Guid> workItemModifiedByIds = default)
        {
