...
namespace TestIt.ApiClient.Model
{
    ...
    public partial class TestSuiteV2GetModel : IEquatable<TestSuiteV2GetModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TestSuiteV2GetModel);
        }

        /// <summary>
        /// Returns true if TestSuiteV2GetModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestSuiteV2GetModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestSuiteV2GetModel input)
        {
            if (input == null)
            {
                return false;
