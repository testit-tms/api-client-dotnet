...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class StepComment : IEquatable<StepComment>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StepComment);
        }

        /// <summary>
        /// Returns true if StepComment instances are equal
        /// </summary>
        /// <param name="input">Instance of StepComment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepComment input)
        {
            if (input == null)
            {
                return false;
