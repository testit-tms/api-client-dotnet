...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPlanChangedFieldsViewModel : IValidatableObject
    {
        ...
        public TestPlanChangedFieldsViewModel(StringChangedFieldWithDiffsViewModel name = default, StringChangedFieldWithDiffsViewModel description = default, StringChangedFieldWithDiffsViewModel productName = default, StringChangedFieldWithDiffsViewModel build = default, PeriodViewModelChangedFieldViewModel period = default, StringChangedFieldWithDiffsViewModel status = default, StringArrayChangedFieldViewModel tags = default, TestSuiteChangeViewModelChangedFieldViewModel testSuite = default, TestPointChangeViewModelChangedFieldViewModel testPoints = default, TestResultChangeViewModelChangedFieldViewModel testResults = default, BooleanChangedFieldViewModel locking = default, BooleanNullableChangedFieldViewModel hasAutomaticDurationTimer = default, Dictionary<string, CustomAttributeChangeModel> attributes = default)
        {
            this.Name = name;
