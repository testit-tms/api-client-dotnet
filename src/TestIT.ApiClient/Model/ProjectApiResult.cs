...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class ProjectApiResult : IValidatableObject
    {
        ...
        /// <param name="isFlakyAuto">Indicates if the status \&quot;Flaky/Stable\&quot; inits automatically (required).</param>
        /// <param name="workflowId">ID of the workflow used in project (required).</param>
        public ProjectApiResult(Guid id = default(Guid), string description = default(string), string name = default(string), bool isFavorite = default(bool), List<CustomAttributeApiResult> attributesScheme = default(List<CustomAttributeApiResult>), List<CustomAttributeApiResult> testPlansAttributesScheme = default(List<CustomAttributeApiResult>), int? testCasesCount = default(int?), int? sharedStepsCount = default(int?), int? checkListsCount = default(int?), int? autoTestsCount = default(int?), bool isDeleted = default(bool), DateTime createdDate = default(DateTime), DateTime? modifiedDate = default(DateTime?), Guid createdById = default(Guid), Guid? modifiedById = default(Guid?), long globalId = default(long), ProjectType type = default(ProjectType), bool isFlakyAuto = default(bool), Guid workflowId = default(Guid))
        {
            this.Id = id;
