...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultApiResult : IValidatableObject
    {
        ...
        public TestResultApiResult(Guid id = default, DateTime? startedOn = default, DateTime? completedOn = default, long? durationInMs = default, string traces = default, string failureType = default, string message = default, Guid? runByUserId = default, Guid? stoppedByUserId = default, string outcome = default, Guid? autoTestId = default, Guid? testPointId = default, Guid testRunId = default, Guid configurationId = default, TestStatusApiResult status = default, TestPointShortApiResult testPoint = default, AutoTestApiResult autoTest = default, List<AutoTestStepResultsApiResult> autoTestStepResults = default, List<AutoTestStepResultsApiResult> setupResults = default, List<AutoTestStepResultsApiResult> teardownResults = default, Guid? workItemVersionId = default, int? workItemVersionNumber = default, List<AttachmentApiResult> attachments = default, List<LinkApiResult> links = default, List<TestResultFailureClassApiResult> failureClasses = default, List<StepCommentApiModel> stepComments = default, Dictionary<string, string> parameters = default, Dictionary<string, string> properties = default, DateTime createdDate = default, DateTime? modifiedDate = default, Guid createdById = default, Guid? modifiedById = default, bool isDeleted = default)
        {
            this.Id = id;
