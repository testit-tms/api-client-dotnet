...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultUpdateV2Request : IValidatableObject
    {
        ...
        public List<AutoTestStepResultUpdateRequest> SetupResults { get; set; }

        /// <summary>
        /// Gets or Sets TeardownResults
        /// </summary>
        [DataMember(Name = "teardownResults", EmitDefaultValue = true)]
        public List<AutoTestStepResultUpdateRequest> TeardownResults { get; set; }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.DurationInMs > (long?)86400000)
            {
                yield return new ValidationResult("Invalid value for DurationInMs, must be a value less than or equal to 86400000.", new [] { "DurationInMs" });
            }
