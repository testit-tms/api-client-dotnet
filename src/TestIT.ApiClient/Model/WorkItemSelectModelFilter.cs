...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkItemSelectModel_filter")]
    public partial class WorkItemSelectModelFilter : IEquatable<WorkItemSelectModelFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemSelectModelFilter" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as WorkItemSelectModelFilter);
        }

        /// <summary>
        /// Returns true if WorkItemSelectModelFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemSelectModelFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemSelectModelFilter input)
        {
            if (input == null)
            {
                return false;
