...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestSuiteHierarchyApiResult")]
    public partial class TestSuiteHierarchyApiResult : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestSuiteHierarchyApiResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestSuiteHierarchyApiResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestSuiteHierarchyApiResult" /> class.
        /// </summary>
        ...
        public TestSuiteHierarchyApiResult(Guid id = default(Guid), string name = default(string), TestSuiteTypeApiResult type = default(TestSuiteTypeApiResult), bool? saveStructure = default(bool?), bool? autoRefresh = default(bool?), DateTime? refreshDate = default(DateTime?), Guid? parentId = default(Guid?), Guid? testPlanId = default(Guid?), List<TestSuiteHierarchyApiResult> children = default(List<TestSuiteHierarchyApiResult>))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
            this.Name = name;
            this.Type = type;
            ...
            {
                throw new ArgumentNullException("saveStructure is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
            this.SaveStructure = saveStructure;
            // to ensure "autoRefresh" is required (not null)
            if (autoRefresh == null)
            {
                throw new ArgumentNullException("autoRefresh is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
            this.AutoRefresh = autoRefresh;
            // to ensure "refreshDate" is required (not null)
            if (refreshDate == null)
            {
                throw new ArgumentNullException("refreshDate is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
            this.RefreshDate = refreshDate;
            // to ensure "parentId" is required (not null)
            if (parentId == null)
            {
                throw new ArgumentNullException("parentId is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
            this.ParentId = parentId;
            // to ensure "testPlanId" is required (not null)
            if (testPlanId == null)
            {
                throw new ArgumentNullException("testPlanId is a required property for TestSuiteHierarchyApiResult and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Collection of child test suites</value>
        [DataMember(Name = "children", EmitDefaultValue = true)]
        public List<TestSuiteHierarchyApiResult> Children { get; set; }
