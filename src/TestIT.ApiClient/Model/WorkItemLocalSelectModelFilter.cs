...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkItemLocalSelectModel_filter")]
    public partial class WorkItemLocalSelectModelFilter : IEquatable<WorkItemLocalSelectModelFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkItemLocalSelectModelFilter" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkItemLocalSelectModelFilter {\n");
        ...
        {
            return this.Equals(input as WorkItemLocalSelectModelFilter);
        }

        /// <summary>
        /// Returns true if WorkItemLocalSelectModelFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemLocalSelectModelFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemLocalSelectModelFilter input)
        {
            if (input == null)
            {
                return false;
