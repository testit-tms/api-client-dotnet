...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TagApiModel : IEquatable<TagApiModel>, IValidatableObject
    {
        /// <summary>
        ...
        public TagApiModel(string name = default(string))
        {
        ...
        {
            return this.Equals(input as TagApiModel);
        }

        /// <summary>
        /// Returns true if TagApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TagApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagApiModel input)
        {
            if (input == null)
            {
                return false;
