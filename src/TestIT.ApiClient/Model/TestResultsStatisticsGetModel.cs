...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsGetModel")]
    public partial class TestResultsStatisticsGetModel : IEquatable<TestResultsStatisticsGetModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TestResultsStatisticsGetModel);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsGetModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsGetModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsGetModel input)
        {
            if (input == null)
            {
                return false;
