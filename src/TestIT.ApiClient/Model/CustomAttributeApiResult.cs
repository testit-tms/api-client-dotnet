...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class CustomAttributeApiResult : IValidatableObject
    {
        ...
        public CustomAttributeApiResult(Guid id = default(Guid), List<CustomAttributeOptionApiResult> options = default(List<CustomAttributeOptionApiResult>), CustomAttributeType type = default(CustomAttributeType), bool isDeleted = default(bool), string name = default(string), bool isEnabled = default(bool), bool isRequired = default(bool), bool isGlobal = default(bool))
        {
            this.Id = id;
