...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class WorkItemMovePostModel : IEquatable<WorkItemMovePostModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkItemMovePostModel);
        }

        /// <summary>
        /// Returns true if WorkItemMovePostModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemMovePostModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemMovePostModel input)
        {
            if (input == null)
            {
                return false;
