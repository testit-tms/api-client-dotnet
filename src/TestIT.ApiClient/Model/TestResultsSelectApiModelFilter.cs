...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultsSelectApiModelFilter : IEquatable<TestResultsSelectApiModelFilter>, IValidatableObject
    {
        ...
        public TestResultsSelectApiModelFilter(List<Guid> configurationIds = default(List<Guid>), List<TestResultOutcome> outcomes = default(List<TestResultOutcome>), List<string> statusCodes = default(List<string>), List<FailureCategoryModel> failureCategories = default(List<FailureCategoryModel>), string _namespace = default(string), string className = default(string), List<long> autoTestGlobalIds = default(List<long>), string name = default(string), TestResultsFilterApiModelCreatedDate createdDate = default(TestResultsFilterApiModelCreatedDate), TestResultsFilterApiModelModifiedDate modifiedDate = default(TestResultsFilterApiModelModifiedDate), TestResultsFilterApiModelStartedOn startedOn = default(TestResultsFilterApiModelStartedOn), TestResultsFilterApiModelCompletedOn completedOn = default(TestResultsFilterApiModelCompletedOn), TestResultsFilterApiModelDuration duration = default(TestResultsFilterApiModelDuration), List<string> resultReasons = default(List<string>), List<Guid> testRunIds = default(List<Guid>))
        {
