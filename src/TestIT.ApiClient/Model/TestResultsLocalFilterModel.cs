...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultsLocalFilterModel : IValidatableObject
    {
        ...
        public TestResultsLocalFilterModel(List<Guid> configurationIds = default(List<Guid>), List<TestResultOutcome> outcomes = default(List<TestResultOutcome>), List<string> statusCodes = default(List<string>), List<FailureCategoryModel> failureCategories = default(List<FailureCategoryModel>), string varNamespace = default(string), string className = default(string))
        {
