...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPointRelatedToTestResult : IEquatable<TestPointRelatedToTestResult>, IValidatableObject
    {
        ...
        public TestPointRelatedToTestResult(Guid testSuiteId = default(Guid), Guid id = default(Guid), Guid? testerId = default(Guid?), Guid? workItemId = default(Guid?), Guid? configurationId = default(Guid?), string status = default(string), Guid? lastTestResultId = default(Guid?), Guid iterationId = default(Guid), long? workItemMedianDuration = default(long?))
        {
