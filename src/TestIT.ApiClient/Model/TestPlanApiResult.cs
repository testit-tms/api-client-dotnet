...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestPlanApiResult : IValidatableObject
    {
        ...
        public TestPlanApiResult(Guid id = default, string name = default, DateTime? startDate = default, DateTime? endDate = default, DateTime? startedOn = default, DateTime? completedOn = default, string description = default, string build = default, Guid? projectId = default, string productName = default, TestPlanStatus status = default, List<TestPlanTagApiResult> tags = default, long globalId = default, bool? hasAutomaticDurationTimer = default, Guid? lockedById = default, DateTime? lockedDate = default, Dictionary<string, Object> attributes = default, DateTime? createdDate = default, DateTime? modifiedDate = default, Guid createdById = default, Guid? modifiedById = default, bool isDeleted = default)
        {
            this.Id = id;
