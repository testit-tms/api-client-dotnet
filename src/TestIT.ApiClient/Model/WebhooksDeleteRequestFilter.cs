...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhooksDeleteRequest_filter")]
    public partial class WebhooksDeleteRequestFilter : IEquatable<WebhooksDeleteRequestFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksDeleteRequestFilter" /> class.
        /// </summary>
        ...
        public WebhooksDeleteRequestFilter(string name = default(string), List<WebHookEventTypeRequest> eventTypes = default(List<WebHookEventTypeRequest>), List<RequestTypeRequest> methods = default(List<RequestTypeRequest>), List<Guid> projectIds = default(List<Guid>), bool? isEnabled = default(bool?))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhooksDeleteRequestFilter {\n");
        ...
        {
            return this.Equals(input as WebhooksDeleteRequestFilter);
        }

        /// <summary>
        /// Returns true if WebhooksDeleteRequestFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhooksDeleteRequestFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhooksDeleteRequestFilter input)
        {
            if (input == null)
            {
                return false;
