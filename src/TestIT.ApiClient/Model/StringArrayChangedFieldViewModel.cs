...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class StringArrayChangedFieldViewModel : IEquatable<StringArrayChangedFieldViewModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StringArrayChangedFieldViewModel);
        }

        /// <summary>
        /// Returns true if StringArrayChangedFieldViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of StringArrayChangedFieldViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringArrayChangedFieldViewModel input)
        {
            if (input == null)
            {
                return false;
