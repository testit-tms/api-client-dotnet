...
namespace TestIT.ApiClient.Model
{
    ...
    /// UpdateTagApiModel
    /// </summary>
    [DataContract(Name = "UpdateTagApiModel")]
    public partial class UpdateTagApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTagApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateTagApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTagApiModel" /> class.
        /// </summary>
        ...
        public UpdateTagApiModel(string name = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateTagApiModel and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateTagApiModel {\n");
