...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class ProjectCustomAttributesTemplatesFilterModel : IEquatable<ProjectCustomAttributesTemplatesFilterModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProjectCustomAttributesTemplatesFilterModel);
        }

        /// <summary>
        /// Returns true if ProjectCustomAttributesTemplatesFilterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectCustomAttributesTemplatesFilterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectCustomAttributesTemplatesFilterModel input)
        {
            if (input == null)
            {
                return false;
