...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class TestResultResponse : IEquatable<TestResultResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TestResultResponse);
        }

        /// <summary>
        /// Returns true if TestResultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultResponse input)
        {
            if (input == null)
            {
                return false;
