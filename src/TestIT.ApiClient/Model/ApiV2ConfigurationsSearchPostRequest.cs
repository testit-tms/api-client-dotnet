...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_configurations_search_post_request")]
    public partial class ApiV2ConfigurationsSearchPostRequest : IEquatable<ApiV2ConfigurationsSearchPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ConfigurationsSearchPostRequest" /> class.
        /// </summary>
        ...
        public ApiV2ConfigurationsSearchPostRequest(List<Guid> projectIds = default(List<Guid>), string name = default(string), bool? isDeleted = default(bool?), List<long> globalIds = default(List<long>))
        {
        ...
        {
            return this.Equals(input as ApiV2ConfigurationsSearchPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2ConfigurationsSearchPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2ConfigurationsSearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2ConfigurationsSearchPostRequest input)
        {
            if (input == null)
            {
                return false;
