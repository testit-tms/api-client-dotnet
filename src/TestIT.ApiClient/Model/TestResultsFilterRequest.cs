...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsFilterRequest")]
    public partial class TestResultsFilterRequest : IEquatable<TestResultsFilterRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsFilterRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestResultsFilterRequest {\n");
        ...
        {
            return this.Equals(input as TestResultsFilterRequest);
        }

        /// <summary>
        /// Returns true if TestResultsFilterRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsFilterRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsFilterRequest input)
        {
            if (input == null)
            {
                return false;
