...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class CreateDefectApiModel : IValidatableObject
    {
        ...
        protected CreateDefectApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDefectApiModel" /> class.
        /// </summary>
        ...
        public CreateDefectApiModel(List<Guid> testResultIds = default(List<Guid>), ExternalFormCreateModel form = default(ExternalFormCreateModel))
        {
            ...
            {
                throw new ArgumentNullException("testResultIds is a required property for CreateDefectApiModel and cannot be null");
            }
            this.TestResultIds = testResultIds;
            // to ensure "form" is required (not null)
            if (form == null)
            {
                throw new ArgumentNullException("form is a required property for CreateDefectApiModel and cannot be null");
            }
            this.Form = form;
        }
