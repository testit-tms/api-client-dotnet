...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestPlanWithAnalyticModel")]
    public partial class TestPlanWithAnalyticModel : IEquatable<TestPlanWithAnalyticModel>, IValidatableObject
    {
        ...
        protected TestPlanWithAnalyticModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPlanWithAnalyticModel" /> class.
        /// </summary>
        ...
        public TestPlanWithAnalyticModel(TestPlanWithAnalyticModelAnalytic analytic = default(TestPlanWithAnalyticModelAnalytic), TestPlanStatusModel status = default(TestPlanStatusModel), DateTime? startedOn = default(DateTime?), DateTime? completedOn = default(DateTime?), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), Guid createdById = default(Guid), Guid? modifiedById = default(Guid?), long globalId = default(long), bool isDeleted = default(bool), DateTime? lockedDate = default(DateTime?), Guid id = default(Guid), Guid? lockedById = default(Guid?), List<TagPostModel> tags = default(List<TagPostModel>), string name = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string description = default(string), string build = default(string), Guid projectId = default(Guid), string productName = default(string), bool? hasAutomaticDurationTimer = default(bool?), Dictionary<string, Object> attributes = default(Dictionary<string, Object>))
        {
            ...
            if (analytic == null)
            {
                throw new ArgumentNullException("analytic is a required property for TestPlanWithAnalyticModel and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TestPlanWithAnalyticModel and cannot be null");
            }
            this.Name = name;
            ...
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for TestPlanWithAnalyticModel and cannot be null");
            }
        ...
        {
            return this.Equals(input as TestPlanWithAnalyticModel);
        }

        /// <summary>
        /// Returns true if TestPlanWithAnalyticModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestPlanWithAnalyticModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestPlanWithAnalyticModel input)
        {
            if (input == null)
            {
                return false;
