...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_workItems__sharedStepId__references_workItems_post_request")]
    public partial class ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest : IEquatable<ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2WorkItemsSharedStepIdReferencesWorkItemsPostRequest input)
        {
            if (input == null)
            {
                return false;
