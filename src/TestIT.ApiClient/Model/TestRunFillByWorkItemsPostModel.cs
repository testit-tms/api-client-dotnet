...
namespace TestIt.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestRunFillByWorkItemsPostModel")]
    public partial class TestRunFillByWorkItemsPostModel : IEquatable<TestRunFillByWorkItemsPostModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunFillByWorkItemsPostModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestRunFillByWorkItemsPostModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunFillByWorkItemsPostModel" /> class.
        /// </summary>
        ...
        public TestRunFillByWorkItemsPostModel(List<Guid> configurationIds = default(List<Guid>), List<Guid> workItemIds = default(List<Guid>), Guid projectId = default(Guid), Guid testPlanId = default(Guid), string name = default(string), string description = default(string), string launchSource = default(string), List<AttachmentPutModel> attachments = default(List<AttachmentPutModel>), List<LinkPostModel> links = default(List<LinkPostModel>))
        {
        ...
        {
            return this.Equals(input as TestRunFillByWorkItemsPostModel);
        }

        /// <summary>
        /// Returns true if TestRunFillByWorkItemsPostModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRunFillByWorkItemsPostModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRunFillByWorkItemsPostModel input)
        {
            if (input == null)
            {
                return false;
