...
namespace TestIT.ApiClient.Model
{
    ...
    public partial class AutoTestStepResultUpdateRequest : IEquatable<AutoTestStepResultUpdateRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AutoTestStepResultUpdateRequest);
        }

        /// <summary>
        /// Returns true if AutoTestStepResultUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AutoTestStepResultUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutoTestStepResultUpdateRequest input)
        {
            if (input == null)
            {
                return false;
