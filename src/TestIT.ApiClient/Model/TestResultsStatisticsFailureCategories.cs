...
namespace TestIT.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestResultsStatisticsFailureCategories")]
    public partial class TestResultsStatisticsFailureCategories : IEquatable<TestResultsStatisticsFailureCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsFailureCategories" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestResultsStatisticsFailureCategories() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestResultsStatisticsFailureCategories" /> class.
        /// </summary>
        ...
        public TestResultsStatisticsFailureCategories(int infrastructureDefect = default(int), int productDefect = default(int), int testDefect = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestResultsStatisticsFailureCategories {\n");
        ...
        {
            return this.Equals(input as TestResultsStatisticsFailureCategories);
        }

        /// <summary>
        /// Returns true if TestResultsStatisticsFailureCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of TestResultsStatisticsFailureCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestResultsStatisticsFailureCategories input)
        {
            if (input == null)
            {
                return false;
