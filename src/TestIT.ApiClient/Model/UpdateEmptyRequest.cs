...
namespace TestIT.ApiClient.Model
{
    ...
    /// UpdateEmptyRequest
    /// </summary>
    [DataContract(Name = "UpdateEmpty_request")]
    public partial class UpdateEmptyRequest : IEquatable<UpdateEmptyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmptyRequest" /> class.
        /// </summary>
        ...
        public UpdateEmptyRequest(Guid id = default(Guid), string name = default(string), string description = default(string), string launchSource = default(string), List<AssignAttachmentApiModel> attachments = default(List<AssignAttachmentApiModel>), List<UpdateLinkApiModel> links = default(List<UpdateLinkApiModel>))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateEmptyRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateEmptyRequest);
        }

        /// <summary>
        /// Returns true if UpdateEmptyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEmptyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEmptyRequest input)
        {
            if (input == null)
            {
                return false;
