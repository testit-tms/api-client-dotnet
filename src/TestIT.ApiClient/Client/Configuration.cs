...
namespace TestIT.ApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.4.0-TMS-5.6";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/5.4.0-TMS-5.6/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 5.4.0-TMS-5.6\n";
