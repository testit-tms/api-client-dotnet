...
namespace TestIT.ApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.0.0-TMS-5.3";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/5.0.0-TMS-5.3/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 5.0.0-TMS-5.3\n";
