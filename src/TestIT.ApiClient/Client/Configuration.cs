...
namespace TestIT.ApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.2.4-TMS-5.5";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/5.2.4-TMS-5.5/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 5.2.4-TMS-5.5\n";
