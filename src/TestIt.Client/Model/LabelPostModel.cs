...
namespace TestIt.Client.Model
{
    ...
    public partial class LabelPostModel : IEquatable<LabelPostModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LabelPostModel);
        }

        /// <summary>
        /// Returns true if LabelPostModel instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelPostModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelPostModel input)
        {
            if (input == null)
            {
                return false;
