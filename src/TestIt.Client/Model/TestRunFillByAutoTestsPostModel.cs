...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestRunFillByAutoTestsPostModel")]
    public partial class TestRunFillByAutoTestsPostModel : IEquatable<TestRunFillByAutoTestsPostModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunFillByAutoTestsPostModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestRunFillByAutoTestsPostModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunFillByAutoTestsPostModel" /> class.
        /// </summary>
        ...
        public TestRunFillByAutoTestsPostModel(Guid projectId = default(Guid), string name = default(string), List<Guid> configurationIds = default(List<Guid>), List<string> autoTestExternalIds = default(List<string>), string description = default(string), string launchSource = default(string))
        {
            this.ProjectId = projectId;
            // to ensure "configurationIds" is required (not null)
            if (configurationIds == null)
            {
                throw new ArgumentNullException("configurationIds is a required property for TestRunFillByAutoTestsPostModel and cannot be null");
            }
            this.ConfigurationIds = configurationIds;
            // to ensure "autoTestExternalIds" is required (not null)
            if (autoTestExternalIds == null)
            {
                throw new ArgumentNullException("autoTestExternalIds is a required property for TestRunFillByAutoTestsPostModel and cannot be null");
            }
        ...
        {
            return this.Equals(input as TestRunFillByAutoTestsPostModel);
        }

        /// <summary>
        /// Returns true if TestRunFillByAutoTestsPostModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRunFillByAutoTestsPostModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRunFillByAutoTestsPostModel input)
        {
            if (input == null)
            {
                return false;
