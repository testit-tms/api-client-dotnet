...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestRunTestResultsSelectModel_filter")]
    public partial class TestRunTestResultsSelectModelFilter : IEquatable<TestRunTestResultsSelectModelFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunTestResultsSelectModelFilter" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TestRunTestResultsSelectModelFilter);
        }

        /// <summary>
        /// Returns true if TestRunTestResultsSelectModelFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRunTestResultsSelectModelFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRunTestResultsSelectModelFilter input)
        {
            if (input == null)
            {
                return false;
