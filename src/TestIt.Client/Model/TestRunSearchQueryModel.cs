...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestRunSearchQueryModel")]
    public partial class TestRunSearchQueryModel : IEquatable<TestRunSearchQueryModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunSearchQueryModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TestRunSearchQueryModel);
        }

        /// <summary>
        /// Returns true if TestRunSearchQueryModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRunSearchQueryModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRunSearchQueryModel input)
        {
            if (input == null)
            {
                return false;
