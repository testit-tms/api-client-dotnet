...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_autoTests_search_post_request")]
    public partial class ApiV2AutoTestsSearchPostRequest : IEquatable<ApiV2AutoTestsSearchPostRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiV2AutoTestsSearchPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV2AutoTestsSearchPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2AutoTestsSearchPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2AutoTestsSearchPostRequest input)
        {
            if (input == null)
            {
                return false;
