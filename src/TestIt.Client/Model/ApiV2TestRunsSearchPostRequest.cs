...
namespace TestIt.Client.Model
{
    ...
    public partial class ApiV2TestRunsSearchPostRequest : IEquatable<ApiV2TestRunsSearchPostRequest>, IValidatableObject
    {
        ...
        public ApiV2TestRunsSearchPostRequest(List<Guid> projectIds = default(List<Guid>), List<TestRunState> states = default(List<TestRunState>), TestRunFilterModelCreatedDate createdDate = default(TestRunFilterModelCreatedDate), List<Guid> modifiedByIds = default(List<Guid>), bool? isDeleted = default(bool?))
        {
