...
namespace TestIt.Client.Model
{
    ...
    public partial class WorkItemFilterModel : IEquatable<WorkItemFilterModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkItemFilterModel);
        }

        /// <summary>
        /// Returns true if WorkItemFilterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemFilterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemFilterModel input)
        {
            if (input == null)
            {
                return false;
