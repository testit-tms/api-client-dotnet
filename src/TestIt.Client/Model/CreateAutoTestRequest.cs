...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAutoTest_request")]
    public partial class CreateAutoTestRequest : IEquatable<CreateAutoTestRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutoTestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAutoTestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutoTestRequest" /> class.
        /// </summary>
        ...
        public CreateAutoTestRequest(List<Guid> workItemIdsForLinkWithAutoTest = default(List<Guid>), bool? shouldCreateWorkItem = default(bool?), string externalId = default(string), List<LinkPostModel> links = default(List<LinkPostModel>), Guid projectId = default(Guid), string name = default(string), string _namespace = default(string), string classname = default(string), List<AutoTestStepModel> steps = default(List<AutoTestStepModel>), List<AutoTestStepModel> setup = default(List<AutoTestStepModel>), List<AutoTestStepModel> teardown = default(List<AutoTestStepModel>), string title = default(string), string description = default(string), List<LabelPostModel> labels = default(List<LabelPostModel>), bool? isFlaky = default(bool?))
        {
            ...
            if (externalId == null)
            {
                throw new ArgumentNullException("externalId is a required property for CreateAutoTestRequest and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateAutoTestRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateAutoTestRequest);
        }

        /// <summary>
        /// Returns true if CreateAutoTestRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAutoTestRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAutoTestRequest input)
        {
            if (input == null)
            {
                return false;
