...
namespace TestIt.Client.Model
{
    ...
    public partial class CreateAndFillByWorkItemsRequest : IEquatable<CreateAndFillByWorkItemsRequest>, IValidatableObject
    {
        ...
        public CreateAndFillByWorkItemsRequest(List<Guid> configurationIds = default(List<Guid>), List<Guid> workItemIds = default(List<Guid>), Guid projectId = default(Guid), Guid testPlanId = default(Guid), string name = default(string), string description = default(string), string launchSource = default(string))
        {
