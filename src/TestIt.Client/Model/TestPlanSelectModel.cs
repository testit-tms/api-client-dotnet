...
namespace TestIt.Client.Model
{
    ...
    public partial class TestPlanSelectModel : IEquatable<TestPlanSelectModel>, IValidatableObject
    {
        ...
        public TestPlanSelectModel(ApiV2ProjectsIdTestPlansSearchPostRequest filter = default(ApiV2ProjectsIdTestPlansSearchPostRequest), TestPlanExtractionModel extractionModel = default(TestPlanExtractionModel))
        {
            this.Filter = filter;
