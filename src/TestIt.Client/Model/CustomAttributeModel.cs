...
namespace TestIt.Client.Model
{
    ...
    public partial class CustomAttributeModel : IEquatable<CustomAttributeModel>, IValidatableObject
    {
        ...
        public CustomAttributeModel(Guid id = default(Guid), List<CustomAttributeOptionModel> options = default(List<CustomAttributeOptionModel>), CustomAttributeTypesEnum type = default(CustomAttributeTypesEnum), bool isDeleted = default(bool), string name = default(string), bool enabled = default(bool), bool required = default(bool), bool isGlobal = default(bool))
        {
            this.Type = type;
        ...
        /// </summary>
        /// <value>Unique ID of attribute</value>
