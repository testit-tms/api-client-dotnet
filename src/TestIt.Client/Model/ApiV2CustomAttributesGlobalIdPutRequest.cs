...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_customAttributes_global__id__put_request")]
    public partial class ApiV2CustomAttributesGlobalIdPutRequest : IEquatable<ApiV2CustomAttributesGlobalIdPutRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2CustomAttributesGlobalIdPutRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV2CustomAttributesGlobalIdPutRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2CustomAttributesGlobalIdPutRequest" /> class.
        /// </summary>
        ...
        public ApiV2CustomAttributesGlobalIdPutRequest(string name = default(string), List<CustomAttributeOptionModel> options = default(List<CustomAttributeOptionModel>), bool? isEnabled = default(bool?), bool? isRequired = default(bool?))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ApiV2CustomAttributesGlobalIdPutRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as ApiV2CustomAttributesGlobalIdPutRequest);
        }

        /// <summary>
        /// Returns true if ApiV2CustomAttributesGlobalIdPutRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV2CustomAttributesGlobalIdPutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV2CustomAttributesGlobalIdPutRequest input)
        {
            if (input == null)
            {
                return false;
