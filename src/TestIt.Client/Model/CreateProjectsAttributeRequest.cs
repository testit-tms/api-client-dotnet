...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateProjectsAttribute_request")]
    public partial class CreateProjectsAttributeRequest : IEquatable<CreateProjectsAttributeRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectsAttributeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateProjectsAttributeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectsAttributeRequest" /> class.
        /// </summary>
        ...
        public CreateProjectsAttributeRequest(List<CustomAttributeOptionPostModel> options = default(List<CustomAttributeOptionPostModel>), CustomAttributeTypesEnum type = default(CustomAttributeTypesEnum), string name = default(string), bool isEnabled = default(bool), bool isRequired = default(bool), bool isGlobal = default(bool))
        {
            this.Type = type;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateProjectsAttributeRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateProjectsAttributeRequest);
        }

        /// <summary>
        /// Returns true if CreateProjectsAttributeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProjectsAttributeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProjectsAttributeRequest input)
        {
            if (input == null)
            {
                return false;
