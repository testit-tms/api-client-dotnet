...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TestRunUpdateMultipleModel")]
    public partial class TestRunUpdateMultipleModel : IEquatable<TestRunUpdateMultipleModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunUpdateMultipleModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestRunUpdateMultipleModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRunUpdateMultipleModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TestRunUpdateMultipleModel);
        }

        /// <summary>
        /// Returns true if TestRunUpdateMultipleModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRunUpdateMultipleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRunUpdateMultipleModel input)
        {
            if (input == null)
            {
                return false;
