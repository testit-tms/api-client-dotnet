...
namespace TestIt.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateConfiguration_request")]
    public partial class CreateConfigurationRequest : IEquatable<CreateConfigurationRequest>, IValidatableObject
    {
        ...
        public CreateConfigurationRequest(string description = default(string), Dictionary<string, string> parameters = default(Dictionary<string, string>), Guid projectId = default(Guid), bool isDefault = default(bool), string name = default(string))
        {
            // to ensure "parameters" is required (not null)
            if (parameters == null)
            {
                throw new ArgumentNullException("parameters is a required property for CreateConfigurationRequest and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateConfigurationRequest and cannot be null");
            }
            this.Name = name;
