...
namespace TestIt.Client.Model
{
    ...
    public partial class AttachmentPutModelAutoTestStepResultsModel : IEquatable<AttachmentPutModelAutoTestStepResultsModel>, IValidatableObject
    {
        ...
        public AttachmentPutModelAutoTestStepResultsModel(string title = default(string), string description = default(string), string info = default(string), DateTime? startedOn = default(DateTime?), DateTime? completedOn = default(DateTime?), long? duration = default(long?), string outcome = default(string), List<AttachmentPutModelAutoTestStepResultsModel> stepResults = default(List<AttachmentPutModelAutoTestStepResultsModel>), List<AttachmentPutModel> attachments = default(List<AttachmentPutModel>), Dictionary<string, string> parameters = default(Dictionary<string, string>))
        {
            this.Title = title;
