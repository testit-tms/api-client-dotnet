...
namespace TestIt.Client.Model
{
    ...
    public partial class WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel : IEquatable<WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel);
        }

        /// <summary>
        /// Returns true if WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkItemStepChangeViewModelArrayChangedFieldWithDiffsViewModel input)
        {
            if (input == null)
            {
                return false;
