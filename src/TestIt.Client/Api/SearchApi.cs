...
namespace TestIt.Client.Api
{
    ...
    public partial class SearchApi : IDisposable, ISearchApi
    {
        ...
        /// <returns></returns>
        public SearchApi(TestIt.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SearchApi(HttpClient client, TestIt.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public SearchApi(TestIt.Client.Client.ISynchronousClient client, TestIt.Client.Client.IAsynchronousClient asyncClient, TestIt.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            TestIt.Client.Client.ApiResponse<GlobalSearchResponse> localVarResponse = ApiV2SearchGlobalSearchPostWithHttpInfo(apiV2SearchGlobalSearchPostRequest);
        ...
        /// <param name="apiV2SearchGlobalSearchPostRequest"> (optional)</param>
        /// <returns>ApiResponse of GlobalSearchResponse</returns>
        public TestIt.Client.Client.ApiResponse<GlobalSearchResponse> ApiV2SearchGlobalSearchPostWithHttpInfo(ApiV2SearchGlobalSearchPostRequest apiV2SearchGlobalSearchPostRequest = default(ApiV2SearchGlobalSearchPostRequest))
        {
        ...
        {
            TestIt.Client.Client.ApiResponse<GlobalSearchResponse> localVarResponse = await ApiV2SearchGlobalSearchPostWithHttpInfoAsync(apiV2SearchGlobalSearchPostRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GlobalSearchResponse)</returns>
        public async System.Threading.Tasks.Task<TestIt.Client.Client.ApiResponse<GlobalSearchResponse>> ApiV2SearchGlobalSearchPostWithHttpInfoAsync(ApiV2SearchGlobalSearchPostRequest apiV2SearchGlobalSearchPostRequest = default(ApiV2SearchGlobalSearchPostRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
