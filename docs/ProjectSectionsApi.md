...
namespace Example
{
    public class GetSectionsByProjectIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ProjectSectionsApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling ProjectSectionsApi.GetSectionsByProjectId: " + e.Message);
...
{
    // Get project sections
    ApiResponse<List<SectionModel>> response = apiInstance.GetSectionsByProjectIdWithHttpInfo(projectId, skip, take, orderBy, searchField, searchValue);
...
{
    Debug.Print("Exception when calling ProjectSectionsApi.GetSectionsByProjectIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
